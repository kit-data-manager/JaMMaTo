...
test_schema1 = MapSchema({"key1": "int", "key2": "str", "key3": "float", "key4": "bool", "key5": "None", "key6": {"key6_1": "str"}, "key7": ["str"], "key8": [{"key8_1": "str"}], "key9": [["str"]],
 "key10": ("str", "int")}, 
 ["key1", "key2", "key3", "key4", "key5", "key6", "key7", "key8", "key9", "key10"], dummy_map)
test_schema2 = MapSchema({"key1": "int", "key2_1": "str"}, 
 ["key1", "key2_1"], dummy_map)
test_schema3 = MapSchema({"key1": "int", "key11": ["str"]}, 
 ["key1", "key11"], dummy_map)
test_schema4 = MapSchema({"key1": "int", "key11": [None]}, 
["key1", "key11"], dummy_map)
