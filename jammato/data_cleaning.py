...
class Data_Cleaning():
    ...
    def set_attributes_from_config(self, flag, config_file_path: str=os.getcwd()+"/NEPMetadataMapping/configs/config_data_cleaning.json",) -> None:
        ...
        Args:
            config_file_path (str, optional): The relative path to the config file directory. Defaults to os.getcwd()+"/NEPMetadataMapping/configs/config_data_cleaning.json".
        """
