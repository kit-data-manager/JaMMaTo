...
class Dicom_Mapping():
    ...
    def __init__(self, map_json_path: str, metadata_files_location: str, mapped_metadata: str='mapped_metadata.json', config_dicom_file_validation: str=os.getcwd()+"/config/config_dicom_file_validation.json") -> None:
